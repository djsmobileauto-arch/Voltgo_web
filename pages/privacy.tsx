            ...
            <section className="mt-8 space-y-8 text-gray-800">
              ...
              <div>
                ...
                <ul className="mt-2 list-disc pl-5 space-y-1">
                  ...
                  {/* NEW: SMS compliance (genérico, sin mencionar RingCentral) */}
                  <li>
                    SMS consent and messaging preferences (opt-in status, timestamps, and message interactions)
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="mt-2 list-disc pl-5 space-y-1">
                  ...
                  {/* NEW: SMS compliance */}
                  <li>
                    Send SMS messages when you opt in (e.g., dispatch updates, appointment coordination, service confirmations,
                    and support messages, and only if you consent—promotional offers)
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="mt-2 list-disc pl-5 space-y-1">
                  <li>Service providers assisting with operations (e.g., payment processors, communications platforms)</li>
                  <li>Legal authorities when required by law</li>
                  <li>Partners necessary to deliver our Services</li>
                </ul>

                {/* NEW: explicit SMS opt-in non-sharing clause */}
                <p className="mt-3 text-sm text-gray-700">
                  <strong>No mobile opt-in or text message consent will be shared with third parties or affiliates</strong>{" "}
              ...
              {/* 4. SMS Messaging */}
              <div>
                <h2 className="text-lg font-medium">4. SMS Messaging</h2>
                <p className="mt-2">
                  VoltGo (operated by DJ&apos;s Mobile Auto Solutions LLC) may send text (SMS) messages to the mobile number
                  you provide <strong>only if you opt in</strong>. These messages may include dispatch/service updates,
                  scheduling and coordination, confirmations, and support communications, and only if you explicitly
                  consent—promotional offers.
                </p>

                <ul className="mt-3 list-disc pl-5 space-y-1">
                  <li>
                    <strong>Consent:</strong> By providing your phone number and opting in, you agree to receive SMS from VoltGo.
                  ...
                  <li>
                    <strong>Message frequency:</strong> May vary depending on your requests and service activity.
                  </li>
                  <li>
              ...
              {/* 6. Changes */}
              <div>
                <h2 className="text-lg font-medium">6. Changes to This Policy</h2>
                <p className="mt-2">
              ...
              <div>
                ...
                <p className="mt-2">If you have questions about this Privacy Policy, contact us at:</p>
                <p className="mt-2 text-sm text-gray-700">
                  Email: <strong>info@voltgo.us</strong>
                  <br />
                  Location: <strong>Wallingford, CT 06492, USA</strong>
                </p>
              </div>
            </section>
          </div>
